 ...
 * start a voice call with an AI travel agent, interact in real-time, 
...
function TravelVoiceAgent() {
    ...
    /**
     * StartCall
     * Initializes and starts the voice call with the AI Travel Voice Agent
    ...
    const StartCall = () => {
        ...
        const VapiAgentConfig = {
            ...
            firstMessage: "Hi there! I'm your AI Travel Assistant. I'm here to help you with any travel questions or plans you might have today. Where would you like to go?",
            transcriber: {
